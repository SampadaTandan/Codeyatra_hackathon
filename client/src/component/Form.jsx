...
//                   type="text"
//                   required
//                   className="block w-full rounded-md bg-white px-6 py-1.5 text-base text-gray-400 outline-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:outline-indigo-600 sm:text-sm font-sans"
//                 />
//               </div>
//             </div>
...
//                   rows="4"
//                   required
//                   className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-400 outline-1 outline-gray-300  placeholder:text-gray-400focus:outline-2 focus:outline-indigo-600 sm:text-sm"
...
// <div>
//   <a href="/subs"> {/* Replace with your actual route */}
//     <button
//       type="submit"
      ...
      <div className="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-4xl">
          <form action="#" method="POST" className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <label htmlFor="industry" className="block text-md font-medium text-gray-800 font-poppins">
                Industry Type
              </label>
              <div className="mt-2">
                <select
            ...
            <div>
              <label htmlFor="profit" className="block text-md font-medium text-gray-800 font-poppins">
                Profit Margin (Numeric Only)
              </label>
              <div className="mt-2">
                <input
            ...
            <div>
              <label htmlFor="valuation" className="block text-md font-medium text-gray-800 font-poppins">
                Valuation (Numeric Only)
              </label>
              <div className="mt-2">
                <input
